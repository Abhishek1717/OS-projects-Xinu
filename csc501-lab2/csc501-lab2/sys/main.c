...
void writer4 (char *msg, int lck, int lck1)
{
        kprintf ("  %s: to acquire lock\n", msg);
        lock (lck, WRITE, DEFAULT_LOCK_PRIO);
...
void reader4 (char *msg, int lck,int lck1)
{
        int     ret;
...
void test4(){
	...
	int rd1,rd2,rd3,rd4,rd5,wr1,wr2,wr3,wr4,wr5;
	
	lck=lcreate();
	lck1=lcreate();	


	rd1 = create(reader3, 2000, 35, "reader3", 2, "reader A", lck1);
        rd2 = create(reader3, 2000, 30, "reader3", 2, "reader B", lck1);
        wr1 = create(writer3, 2000, 25, "writer3", 2, "writer", lck);
	wr2 = create(writer4 ,2000, 20, "writer4", 3, "writer C", lck, lck1);
	rd3 = create(reader4 ,2000, 40,	"reader4", 3, "reader D", lck, lck1);
	rd4 = create(reader4, 2000, 100, "reader4", 3, "reader E", lck, lck1);
